    ...
    <div>
      ...
      <div className="px-5 md:px-32 mb-24">
        ...
        <div className="md:flex justify-between mt-9 md:mt-10">
          ...
          <div className=" md:ml-17 mt-7 self-center">
            ...
            <div className="flex mt-7 md:mt-10">
              ...
              <div className="ml-4 self-center">
                <p className="text-[#002A47] text-sm md:text-base">Dr. Yetunde Wonda</p>
      ...
      <div className="px-5 md:px-32 md:pt-28 pt-20 md:pb-28 pb-20 bg-[#EFF2FA]">
        <p className="md:text-4xl text-2xl text-[#002A47] font-bold max-w-[476px]">Stay updated by joining our newsletter</p>
