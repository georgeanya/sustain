...
const PatientStories = () => {
  ...
  return (
    <>
      ...
      <div className="px-5 md:px-32 md:mt-[50px]">
        <Link href="/blog">
          <div className="flex items-center cursor-pointer">
            ...
            <p className="ml-1.5 text-[16px] leading-5 md:text-[18px] md:leading-[22.7px] font-medium text-[#002A47]">
              Custodia Blog
            </p>
          </div>
        </Link>
      ...
      <div className="px-5 md:px-32 mt-[32px] md:mt-[40px] grid md:grid-cols-3 md:grid-rows-1 md:gap-y-26 gap-15 md:mb-18 mb-15">
          ...
          return (
            ...
            >
              <div>
                ...
                <Link href={`/blog/${attributes.slug}`}>
                  <a className="text-[#002A47] font-bold text-[22px] leading-[28px] md:leading-[29px] mt-[12px] cursor-pointer">
                    {attributes.title}
                  </a>
                </Link>
              </div>
