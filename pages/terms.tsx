  ...
  return (
    <div className="px-5 lg:px-72 pt-18 lg:pt-20 pb-32">
      ...
      <p className="mt-5 md:mt-6 text-base md:text-center lg:text-start lg:text-xl text-[#476D85]">
        By accessing the website at https://getsustain.app, you are agreeing to
      ...
      <p className="mt-3 md:mt-3 text-base md:text-center lg:text-start lg:text-xl text-[#476D85]">
        ...
        of rights. Further, Sustain does not warrant or make any representations
      ...
      <p className="mt-3 md:mt-3 text-base md:text-center lg:text-start lg:text-xl text-[#476D85]">
        ...
        any time without notice. However Sustain does not make any commitment to
