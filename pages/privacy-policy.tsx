  ...
  return (
    <div>
      ...
      <div className="px-5 lg:px-72 md:mt-24 mt-16 pb-32">
        ...
        <p className="mt-5 md:mt-6 text-base md:text-center lg:text-start lg:text-xlg text-[#476D85]">
        ...
        <p className="mt-5 md:mt-7 text-base md:text-center lg:text-start lg:text-xlg text-[#476D85]">
        ...
        <p className="mt-5 md:mt-5 text-base md:text-center lg:text-start lg:text-xlg text-[#476D85]">
