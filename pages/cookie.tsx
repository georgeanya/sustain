...
const Cookie = () => {
  return (
    <div>
      <Navbar1 />
      <div className="px-5 lg:px-72 lg:px md:mt-24 mt-16 pb-32">
        <h2 className="text-4lg md:text-center lg:text-start lg:text-5xl font-bold text-[#002A47]">
          Cookie policy
        </h2>
        <p className="mt-5 md:mt-5 text-base leading-7 md:text-center lg:text-start md:text-2lg text-[#476D85]">
          If you’re curious about our evidence-backed approach, feel free to
          check out the below research.
        </p>
        <ul className="list-disc list-outside pl-5">
          <li className="mt-4 md:mt-5 text-base leading-7 md:text-center lg:text-start underline md:text-2lg text-[#476D85]">
