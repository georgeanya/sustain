  ...
  return (
    <div className="px-5 lg:px-72 lg:px pt-18 lg:pt-20 pb-32">
      ...
      <p className="mt-5 md:mt-5 text-base md:text-center lg:text-start lg:text-xl text-[#476D85]">
        ...
        out the below research.
      </p>
      <ul className="list-disc list-outside pl-5">
        <li className="mt-4 md:mt-5 text-base md:text-center lg:text-start underline lg:text-xl text-[#476D85]">
        ...
        <li className="mt-4 md:mt-5 text-base md:text-center lg:text-start underline lg:text-xl text-[#476D85]">
          The effects of low-fat, high-carbohydrate diets vs. low-carbohydrate,
          high-fat diets on weight, blood pressure, serum liquids and blood
          glucose: a systematic review and meta-analysis{" "}
        ...
        <li className="mt-4 md:mt-5 text-base md:text-center lg:text-start underline lg:text-xl text-[#476D85]">
          Low carbohydrate diet to achieve weight loss and improve HbA1c in type
          2 diabetes and pre-diabetes: Experience from one general practice{" "}
          <span className="no-underline"> (2014)</span>
        </li>
        <li className="mt-4 md:mt-5 text-base md:text-center lg:text-start underline lg:text-xl text-[#476D85]">
          ...
          restriction <span className="no-underline"> (2005)</span>
        </li>
        <li className="mt-4 md:mt-5 text-base md:text-center lg:text-start underline lg:text-xl text-[#476D85]">
