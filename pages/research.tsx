...
const Research = () => {
  return (
    <div>
      ...
      <Navbar1 />
      <div className="px-5 lg:px-32 lg:px md:mt-24 mt-16 pb-32">
        <h2 className="text-4lg md:text-center lg:text-start lg:text-5xl font-bold text-[#002A47]">
          Peer-reviewed studies
        </h2>
        <p className="mt-5 md:mt-5 text-base md:text-center lg:text-start lg:text-2lg text-[#476D85] max-w-lg">
