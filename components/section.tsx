    ...
    <div>
      <div className="md:max-w-md lg:max-w-xl">
        ...
        <p className="mt-6 text-base  lg:text-start lg:text-xl text-[#476D85]">
          ...
          what you do, your blood sugar or blood pressure continues to go up and
          you don’t feel well. The medications you have to take keep increasing,
          costing a lot of money. Nothing seems to work, and you don’t feel
          well.
        </p>
        <p className="mt-6 text-base  lg:text-start lg:text-xl text-[#476D85]">
