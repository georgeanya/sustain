      ...
      <div className="max-w-[357px]">
        ...
        <div className="mt-7">
          ...
          <p className="text-[#476D85] mt-4 md:mt-5 text-base leading-6 md:leading-7 md:text-lg">
            There are many reasons that understanding your blood glucose levels
            is beneficial — they are a key indicator of health, and they are
            especially useful in understanding your risk for prediabetes or type
            2 diabetes.
          </p>
